...
// Write a simple calculator that takes an operator (+, -, , /, %) as input, and performs the operation on two numbers. Print the output on the console.console.log(==============ATM Cash Withdrawal System===============)
console.log("==============Build a Calculator===============");
let operator = "*";
...
// based on a person’s birth month. Make it month bases, not date based. Like March and April borns are Aries, Aplil and May born are Taurus, and so on. Do not use if-else.
